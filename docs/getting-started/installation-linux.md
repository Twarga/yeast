...
```bash
curl -fsSL https://raw.githubusercontent.com/Twarga/yeast/main/install.sh | YEAST_VERSION=v1.1.3 bash
```
...
|---|---|---|
| `YEAST_VERSION` | `v1.1.3` | Release tag to install |
